            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tambah Mitra Kerja Sama</h4>
                                
                                <div class="basic-form">
                                    <form>
                                        <div class="form-group">
                                            <input type="text" class="form-control input-default" placeholder="Nama Mitra">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control input-flat" placeholder="Asal Mitra">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control input-rounded" placeholder="Tujuan Mitra">
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Deskripsi Mitra</h4>
                                <div class="basic-form">
                                    <form>
                                        <div class="form-group">
